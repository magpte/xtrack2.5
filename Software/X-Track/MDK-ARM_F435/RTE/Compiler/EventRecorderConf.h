...
#define EVENT_RECORD_MASK      0xFFFFFFFF   // record everything by default
#define EVENT_RECORD_INFO      0
#define EVENT_RECORD_DATA      1
#define EVENT_RECORD_SIZE      16384        // bytes; bump this up
